        ...
        <div className="page home">
            ...
            <section className="about-me">
                ...
                <p>
                    ...
                    where I overhauled and enhanced a popular machine learning package to improve its performance and
                    usability.
                </p>
                <p>
                ...
                <button className="font-bold link link--zoomies">
                    <Link to="/resume">View my Resume</Link>
                </button>
            </section>

            {/* TODO: Uncomment and style with missing star icon; remove unnecessary class names */}
